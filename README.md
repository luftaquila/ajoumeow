...
* 회원 정보를 변경하는 방법은 [4. 회원 관리](https://github.com/luftaquila/ajoumeow/blob/master/README.md#4. 멤버 관리)를 참고하세요.
...
### 급식 인증
  ...
  1. 시험 기간이나 방학 및 공휴일, 악천후 등 급식이 어려울 땐 버닝 타임🔥 이벤트로 마일리지를 상향 지급합니다. 이럴 때 상향 지급 체크박스를 체크하세요.
