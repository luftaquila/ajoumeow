...
> 본 시스템은 데이터베이스로 Google Spreadsheet를, Google Apps Script 서비스를 DB 수정 및 CORS정책 우회를 위한 프록시 서버로 사용하고 있습니다. [(코드)](https://github.com/luftaquila/ajoumeyoumeow/blob/master/Resources/Apps%20Script.gs)  
