$(function() {
  $('#content').click();
  $.ajax({
    url: `${api}/registrations/semesters`,
    ...
    success: res => {
      ...
      $('#newMemberList').DataTable({
        ...
        ajax: {
          ...
          beforeSend: xhr => xhr.setRequestHeader('Authorization', 'Bearer ' + Cookies.get('jwt')),
          data: d => { d.semester = $('#tableName').val() },
          dataSrc: 'data',
    ...
    success: res => {
      ...
      if($('#contactType').val() == 'google') {
        ...
        for(let obj of res.data)
          csv += obj.studentId + ' ' + obj.name + ',' + obj.studentId + ' ' + obj.name + ',,,,,,,,,,,,,,,,,,,,,,,,,,,,,' + $('#contactTable').val() + '학기 미유미유 ::: * myContacts, ::: * myContacts,' + obj.phone + '\n';
      }
        ...
        for(let obj of res.data)
          csv += obj.studentId + ' ' + obj.name + ',,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,' + obj.phone + ',,,,,,,,,,,,,,,,,,,,,,,,,,,,,' + $('#contactTable').val() + '학기 미유미유,\n';
      }
